...
/**
 * This class is includes parser methods for 
 * parsing the GameWorld.xml file.
 * 
...
public class Parser {
	...
	private int getIntegerAttribute(HashMap<String, String> vals, String name, String errorMessage) throws XMLParseException {
		try {
	...
	private String getStringAttribute (HashMap<String, String> vals, String name, String errorMessage) throws XMLParseException {
		
		String val = vals.get(name);
		if (val == null) throw new XMLParseException(errorMessage);
		return val;
	}
