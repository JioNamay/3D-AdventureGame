    ...
    switch (probability) {
      ...
      case 2:
        return "September 2 XXXX: I finally drank the contents of that bottle. "
            + "I don't think there's anything special about it. I guess I felt less " 
            + "tired after drinking it.";
      case 3:
        return "It seems this book got wet at some point. The words are illegible.";
      case 4:
        return "May 20 XXXX: My momma always told me to do unto others as you would have " 
            + "them do to you. "
            + "She was right.";
      case 5:
  ...
  public List<String> getActions() {
    ...
    if (Player.getInstance().getEquippedWeapon().equals(this)) {
      return Arrays.asList(Action.EXAMINE.toString(), Action.READ.toString(),
          Action.UNEQUIP.toString(), Action.DROP.toString());
    }
