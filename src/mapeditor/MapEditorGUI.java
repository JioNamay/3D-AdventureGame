  ...
  private class BoardPanel extends JLayeredPane {
    ...
    class BoardPanelTile extends JLayeredPane implements MouseListener {
      ...
      public void mouseClicked(MouseEvent e) {
          ...
          if (selectedItem.equals("door")) {
            ...
            if (((x == 3 && (y == 0 || y == 6)) || y == 3 && (x == 0 || x == 6))) {
              ...
              JOptionPane.showMessageDialog(frame,
                  "The door must be placed in a highlighted area!");
        ...
        if (selectedItem.equals(" ") && rotateMode == false && deleteMode == false
            && (roomMap[x][y] == 1101 || roomMap[x][y] == 1102 || roomMap[x][y] == 1103
                || roomMap[x][y] == 1104)) {
          ...
          if (((x == 3 && (y == 0 || y == 6)) || y == 3 && (x == 0 || x == 6))) {
            ...
            JOptionPane optionPane = new JOptionPane("This door leads to:",
                JOptionPane.QUESTION_MESSAGE, JOptionPane.DEFAULT_OPTION, null, doorToRoomStrings,
                null);
