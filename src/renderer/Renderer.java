...
public class Renderer {
	...
	/**
	 * Returns the direction corresponding to the current rotation of the board.
	 *
	 * @return the direction
	 */
	public Direction getRotationDirection() {
		return (BOARD_ROTATION % 4 == 0) ? Direction.NORTH
				: (BOARD_ROTATION % 4 == 1) ? Direction.EAST
						: (BOARD_ROTATION % 4 == 2) ? Direction.SOUTH : Direction.WEST;
	}
